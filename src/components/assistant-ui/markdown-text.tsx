...
const defaultComponents = memoizeMarkdownComponents({
  ...
  a: ({ className, ...props }) => (
    <a
      className={cn(
        "aui-md-a text-[#4318FF] underline underline-offset-2 hover:text-[#3311CC]",
        className,
      )}
      {...props}
    />
  ...
  hr: ({ className, ...props }) => (
    <hr
      className={cn("aui-md-hr my-2 border-[#A3AED0]/30", className)}
      {...props}
    />
  ),
  ...
  th: ({ className, ...props }) => (
    <th
      className={cn(
        "aui-md-th bg-[#F4F7FE] px-2 py-1 text-start font-medium first:rounded-ss-lg last:rounded-se-lg [[align=center]]:text-center [[align=right]]:text-right",
        className,
      )}
      {...props}
    />
  ...
  td: ({ className, ...props }) => (
    <td
      className={cn(
        "aui-md-td border-[#A3AED0]/30 border-s border-b px-2 py-1 text-start last:border-e [[align=center]]:text-center [[align=right]]:text-right",
        className,
      )}
      {...props}
    />
  ...
  pre: ({ className, ...props }) => (
    <pre
      className={cn(
        "aui-md-pre overflow-x-auto rounded-t-none rounded-b-lg border border-[#A3AED0]/30 border-t-0 bg-[#F4F7FE]/50 p-3 text-xs leading-relaxed text-[#2B3674]",
        className,
      )}
      {...props}
    />
  ...
  code: function Code({ className, ...props }) {
    ...
    return (
      <code
        className={cn(
          !isCodeBlock &&
            "aui-md-inline-code rounded-md border border-[#A3AED0]/30 bg-[#F4F7FE] px-1.5 py-0.5 font-mono text-[0.85em] text-[#4318FF]",
          className,
        )}
        {...props}
      />
