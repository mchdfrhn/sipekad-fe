  ...
  return (
    ...
    >
      <Card
        onClick={onClick}
        className={cn(
          "border-none shadow-sm card-shadow rounded-[20px] transition-smooth duration-300",
      ...
      >
        <CardContent className="p-4 flex items-center gap-4">
          <div
            className={cn(
              "h-14 w-14 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110",
              iconBgClass,
            )}
          >
