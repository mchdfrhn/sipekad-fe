          ...
          >
            {isSuccess ? (
              <div className="text-center py-8">
                ...
                <h2 className="text-3xl font-bold text-[#2B3674] mb-3">Link Terkirim!</h2>
                <p className="text-[#718096] font-medium mb-2">
                  Link reset password telah dikirim ke WhatsApp Anda.
                </p>
                <p className="text-[#718096] text-sm">
                  Mengalihkan ke login dalam <span className="font-bold text-[#4318FF]">{countdown}</span> detik...
                </p>
              </div>
            ) : (
              <>
                <div className="mb-10 text-center md:text-left">
                  <h2 className="text-3xl font-bold text-[#2B3674] mb-3">Pulihkan Akses</h2>
                  <p className="text-[#718096] font-medium">Masukkan username Anda untuk mendapatkan link reset password melalui WhatsApp.</p>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="h-14 pl-12 rounded-2xl bg-[#F4F7FE] border-none placeholder:text-[#718096] focus:ring-2 focus:ring-[#4318FF]/20 transition-all font-medium text-base"
                      />
                    </div>
                  </div>
